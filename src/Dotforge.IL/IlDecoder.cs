        ...
        while (il.RemainingBytes > 0)
        {
            ...
            if (opByte == 0xFE)
            {
                ...
                instructions.Add(ext switch
                {
                    ...
                    0x03 => new IlInstruction(offset, IlOpCode.CgtUn),
                    0x04 => new IlInstruction(offset, IlOpCode.Clt),
                    0x05 => new IlInstruction(offset, IlOpCode.CltUn),
            ...
            instructions.Add(opByte switch
            {
                ...
                0x8E => new IlInstruction(offset, IlOpCode.Ldlen),
                0x26 => new IlInstruction(offset, IlOpCode.Pop),
                0x28 => new IlInstruction(offset, IlOpCode.Call, il.ReadInt32()),
                0x29 => new IlInstruction(offset, IlOpCode.Calli, il.ReadInt32()),
                ...
                0x94 => new IlInstruction(offset, IlOpCode.LdelemI4),
                0x9E => new IlInstruction(offset, IlOpCode.StelemI4),
                0x9A => new IlInstruction(offset, IlOpCode.LdelemRef),
                0xA2 => new IlInstruction(offset, IlOpCode.StelemRef),
